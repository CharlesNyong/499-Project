...
$arrFailedShipment = getFailedShipments();
ob_start();
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Shipments</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Failed Shipments</h4>
                                <div class="table-responsive">
                                    <table width="100%" border="1" id="data" class="display" cellspacing="0">
                                        <thead>
                                            ...
                                            <tbody>
                                                <?
                                                    foreach ($arrFailedShipment as $intIndex => $arrRows) {?>
                                                        <tr>
